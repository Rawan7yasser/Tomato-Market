...
const Cart = () => {
const {removeElement,addNewCardItem,open, setOpen ,cardItem,handelTotalCost,totalCost,handelOrders,total,orderCost,cardTotalCost}=useContext(ItemContext)
...
const findItem=(item)=>{
  ...
  return (
    <div className="cart" >
      ...
      <td> <img src={item.image} alt="" className="item-image" /></td>
      ...
      <IoMdCloseCircleOutline onClick={()=>removeElement(item.title)} className="close-item" />
